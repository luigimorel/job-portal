            ...
            <div className="flex w-full flex-wrap">
              <div className="w-full">
                <div className="flex flex-col mb-3">
                  <label
                    className="text-base font-bold text-gray-800 dark:text-gray-100  mb-2"
                    htmlFor="email"
                  >
                    Email
                  </label>
                  <input
                    ...
                    className="focus:outline-none   dark:placeholder-gray-400 dark:border-gray-700  focus:border-indigo-700 border-gray-300 border rounded-sm py-2 outline-none pl-2 pr-2"
                  />
                </div>
                <button
                  type="submit"
                  className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 hover:bg-indigo-600 text-white text-base w-full py-3 px-6 rounded"
                >
