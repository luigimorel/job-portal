...
export default function Navbar() {
  ...
  return (
    <>
      <div className="fixed z-50 dark:bg-gray-900  px-3 md:py-4 py-2 sm:px-20 lg:px-40 top-0 w-full">
        <nav className="container flex justify-between items-center z-20">
          ...
          <div className="hidden lg:block text-sm">
            {menuList.map(x => (
              <Link className="mx-3 py-5 text-base text-gray-800 dark:text-white " to={x.route}>
                {x.text}
              </Link>
            ))}
          </div>
      ...
      <div className={`fixed inset-0 z-30 bg-gray-800 bg-opacity-50 scroll-m-0 ${isOpen ? "block" : "hidden"}`}>
        <div className="bg-white dark:bg-gray-800 h-screen justify-center text-xl items-center text-gray-800 dark:text-gray-50 flex flex-col text-center ">
