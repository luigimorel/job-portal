...
export default function Navbar() {
  ...
  return (
    <>
      <div className="fixed z-50 shadow-lg bg-white  px-3 md:py-1.5 py-2 sm:px-20 lg:px-40 top-0 w-full">
        <nav className="container w-full flex justify-between items-center z-20">
          ...
          <Link className=" text-base" to={"/post-job"}>
            <button className="focus:outline-none lg:text-lg lg:font-bold focus:ring-2  focus:ring-indigo-700 hidden md:block bg-transparent transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-indigo-700  text-indigo-700 px-4 sm:px-8 py-1 sm:py-2 text-sm">
              Post a job
            </button>
          </Link>
      ...
      <div className={`fixed inset-0 z-30 bg-gray-800 bg-opacity-50 scroll-m-0 ${isOpen ? "block" : "hidden"}`}>
        <div className="bg-white  h-screen justify-center text-xl items-center text-gray-800  flex flex-col text-center ">
          {mobileMenuList.map(x => (
