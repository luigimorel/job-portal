          ...
          <div className="flex flex-row items-center border px-4 py-2  rounded-md xl:flex mb-4 justify-between xl:items-center lg:items-center md:flex">
            <div className=" flex flex-row items-center ">
              <img
                src={x.logo}
                alt=""
                className=" sm:h-16 h-12 w-auto rounded-full"
              />

              <div className=" flex flex-col ml-4">
                <h5 className=" sm:text-xl text-sm capitalize">{x.title}</h5>
                <h5 className=" sm:text-xl text-sm capitalize ">{x.company}</h5>
                <h5 className=" text-sm capitalize">{x.continent}</h5>
                  ...
                  <div className=" flex flex-row items-center">
                    <div className=" flex flex-row mr-3">
                      <img
                        ...
                        alt=""
                      />
                      <p className=" text-sm capitalize">{x.job_type}</p>
                    </div>
                  </div>
                  <div className=" flex flex-row mr-3">
                    <img
