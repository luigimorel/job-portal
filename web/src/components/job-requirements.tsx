    ...
    <div className="  flex flex-row justify-center text-white">
      <div className=" flex items-center flex-col w-1/2">
        ...
        <div>
          ...
          <p className=" mb-5">
            The most important characteristic of our support team is that we love helping developers. GitHub is a place
            for people to work better, together. Our job is to help. Support treats users the way we’d want someone to
            treat our friends. Our support teammates have excellent writing chops: stellar grammar, charming written
            personality, and the ability to explain complicated things simply. We measure our success in swiftness,
          ...
          <div className=" mb-5">
            ...
            <ul className=" list-disc ml-4">
              ...
              <li>
                Experience using the command line Experience interacting with APIs and troubleshooting related requests
              </li>
